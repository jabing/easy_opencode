...
test('batch20 makes execution-policy, semantic-index, and skills-manifest strict-safe', () => {
  ...
  for (const file of [
    ...
    assert.ok(!manifestPaths.includes(file), `${file} should be strict-safe in batch20`);
  }
