...
test('batch19 repairs quarantine drift and makes support-tier/capability registry strict-safe', () => {
  ...
  for (const file of [
    ...
    assert.ok(!manifestPaths.includes(file), `${file} should be strict-safe in batch19`);
  }
