...
Easy OpenCode is an OpenCode plugin with 16 specialized agents, 51 skills, 60 commands, and a slimmer product kernel centered on implementation, review, quality, release evidence, and project profiling workflows.
